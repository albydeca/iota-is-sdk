...
public class SearchChannelAndValidateData {
	...
	public static void main(String args[]) throws Exception {
		...
		System.out.println("Created channel with address " + newChannelDetails.getString("channelAddress"));
		...
		List<ChannelInfo> channels = userClient.search(null, channelOwner.getJSONObject("doc").getString("id"),
		...
		ownerClient.authorizeSubscription(channelAddress,
				new JSONObject().put("subscriptionLink", subRequest.getString("subscriptionLink")));
